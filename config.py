...
class Config(object):
	...
	def __init__(self, key_file = 'finti.key'):
		...
		self.buildings_uri_path = '/org/%s/buildings' % self.buildings_api_version
		...
		self.tokens_api_version = 'v1'
		self.tokens_uri_path = '/inf/%s/tokens' % self.tokens_api_version
		...
		self.tokens_pubsub_channel = 'tokens_pubsub'
