...
class Config(object):
	...
	def __init__(self, key_file = 'finti.key'):
		...
		self.buildings_uri_path = '/erp/gen/%s/buildings_app' % self.buildings_api_version
		...
		self.tokens_uri_path = '/erp/gen/%s/tokens_app' % self.tokens_api_version
		...
		self.tokens_pubsub_key = 'tokens_app'
