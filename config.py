...
class Config(object):
	...
	def __init__(self, key_file = 'finti.key'):
		...
		self.tokens_google_client_login = self.decode('fceddff3b271088108b9a8e45f17f55c')
		self.tokens_google_client_password = self.decode('22d4bbf3d73e48ae88b1d6453371026d')
		self.tokens_spreadsheet_id = '1WAtIaVCOoPRByHhw28QHykFpCjVQYchowsIEjWZ8oU4'
		self.tokens_worksheet_id = 'o7s09ch'
