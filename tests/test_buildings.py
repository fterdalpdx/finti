...
class BuildingsTest(TestCase):
	...
	def test_get_buildings(self):
		...
		rv = Client.get(self.client, path='/erp/gen/v1/buildings',
						 headers=h)
		self.assert_200(rv)
	...
	def test_get_building_history(self):
		...
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		rv = Client.get(self.client, path='/erp/gen/v1/buildings/B0038/history',
						 headers=h)
	...
	def test_get_building(self):
		...
		#EB_rv = self.app.get('/erp/gen/v1/buildings', query_string=dict(building_identifier='B0038'))
		h = Headers()
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		EB_rv = Client.get(self.client, path='/erp/gen/v1/buildings',
		...
		#EB_rv = self.app.get('/erp/gen/v1/buildings/0000038')
		h = Headers()
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		EB_rv = Client.get(self.client, path='/erp/gen/v1/buildings/0000000038', headers=h)
		...
		#EB_rv = self.app.get('/erp/gen/v1/buildings', query_string=dict(building_identifier='0000038'))
		h = Headers()
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		EB_rv = Client.get(self.client, path='/erp/gen/v1/buildings',
	...
	def test_add_building(self):
		...
		#HEMB_rv = self.app.post('/erp/gen/v1/buildings', data=json.dumps(HEMB), headers={'Content-type': 'application/json'} )
		...
		HEMB_rv = Client.post(self.client, path='/erp/gen/v1/buildings', data=json.dumps(HEMB),
						 headers=h)
	...
	def test_building_is_valid(self):
		...
		HEMB_rv = Client.put(self.client, path='/erp/gen/v1/buildings', data=json.dumps(HEMB),
						 headers=h)
		...
		#HEMB_rv = self.app.post('/erp/gen/v1/buildings', data=json.dumps(HEMB_PLUS), headers={'Content-type': 'application/json'} )
		h = Headers()
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		h.add('Content-type', 'application/json')
		
		HEMB_rv = Client.put(self.client, path='/erp/gen/v1/buildings', data=json.dumps(HEMB_PLUS),
						 headers=h)
		self.assertFalse(HEMB_rv.status_code == 200)
		...
		#HEMB_rv = self.app.post('/erp/gen/v1/buildings', data=json.dumps(HEMB_MINUS), headers={'Content-type': 'application/json'} )
		h = Headers()
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		h.add('Content-type', 'application/json')
		
		HEMB_rv = Client.put(self.client, path='/erp/gen/v1/buildings', data=json.dumps(HEMB_MINUS),
						 headers=h)
		self.assertFalse(HEMB_rv.status_code == 200)
		...
		#HEMB_rv = self.app.post('/erp/gen/v1/buildings', data=json.dumps(HEMB_NON_NUM), headers={'Content-type': 'application/json'} )
		h = Headers()
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		h.add('Content-type', 'application/json')
		
		HEMB_rv = Client.put(self.client, path='/erp/gen/v1/buildings', data=json.dumps(HEMB_NON_NUM),
						 headers=h)
		self.assertFalse(HEMB_rv.status_code == 200)
		...
		HEMB_ASCII = HEMB
		HEMB_ASCII["city"] = 123
		#HEMB_rv = self.app.post('/erp/gen/v1/buildings', data=json.dumps(HEMB_ASCII), headers={'Content-type': 'application/json'} )
		h = Headers()
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		h.add('Content-type', 'application/json')
		
		HEMB_rv = Client.put(self.client, path='/erp/gen/v1/buildings', data=json.dumps(HEMB_ASCII),
						 headers=h)
		self.assertFalse(HEMB_rv.status_code == 200)
		...
		HEMB_NULL = HEMB
		HEMB_NULL["city"] = ''
		#HEMB_rv = self.app.post('/erp/gen/v1/buildings', data=json.dumps(HEMB_NULL), headers={'Content-type': 'application/json'} )
		h = Headers()
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		h.add('Content-type', 'application/json')
		
		HEMB_rv = Client.put(self.client, path='/erp/gen/v1/buildings', data=json.dumps(HEMB_NULL),
						 headers=h)
		self.assertFalse(HEMB_rv.status_code == 200)
...
#		HEMB_rv = self.app.post('/erp/gen/v1/buildings', data=json.dumps(HEMB_LONG), headers={'Content-type': 'application/json'} )
		h = Headers()
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		h.add('Content-type', 'application/json')
		
		HEMB_rv = Client.put(self.client, path='/erp/gen/v1/buildings', data=json.dumps(HEMB_LONG),
						 headers=h)
		self.assertFalse(HEMB_rv.status_code == 200)
		...
		HEMB_SHORT = HEMB
		HEMB_SHORT["city"] = ' '
		#HEMB_rv = self.app.post('/erp/gen/v1/buildings', data=json.dumps(HEMB_SHORT), headers={'Content-type': 'application/json'} )
		h = Headers()
		h.add('Authorization',
			  'Basic ' + base64.b64encode(self.token + ':'))
		h.add('Content-type', 'application/json')
		
		HEMB_rv = Client.put(self.client, path='/erp/gen/v1/buildings', data=json.dumps(HEMB_SHORT),
						 headers=h)
		self.assertFalse(HEMB_rv.status_code == 200)
	...
	def test_update_building(self):
		...
		HEMB_rv = self.app.put('/erp/gen/v1/buildings', data=json.dumps(HEMB), headers=h )
		self.assertTrue(HEMB_rv.status_code == 200)
		HEMB_rv_data = json.loads(HEMB_rv.data)
	...
	def test_delete_building(self):
		...
		HEMB_rv = self.app.delete('/erp/gen/v1/buildings/888')	# Delete the new building and check the result
		self.assertTrue(HEMB_rv.status_code == 200)
		self.assertTrue(HEMB_rv.data == "building removed")
		
		HEMB_rv = self.app.get('/erp/gen/v1/buildings/888')	# Really check to see if the building is gone
		self.assertTrue(HEMB_rv.status_code == 404)
		
		# Test the deletion of a non-existent building
		
		HEMB_rv = self.app.delete('/erp/gen/v1/buildings/080808')	# Delete the new building and check the result
		self.assertTrue(HEMB_rv.status_code == 404)
